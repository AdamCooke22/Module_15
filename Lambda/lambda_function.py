...
# get_recomendation based on certain risk level
def get_recomendation(risk_level, intent_request):
...
def validation(age, intent_request, investment_amount):
    ...
    if age is not None:
        age = parse_int(age)
        if age < 0:
            return build_validation_result(False, "age", "The input age is incorrect")
        elif age > 64:
            return build_validation_result(False,"age", "The age is greater than 64")
    if investment_amount is not None:
        investment_amount = parse_int(investment_amount)
        if investment_amount < 5000:
            return build_validation_result(False,"investment_amount","The investment amount is less than 5000 dollars")
...
def recommend_portfolio(intent_request):
    ...
    if source == "DialogCodeHook":
        ...
        validation_result = validation(age, intent_request, investment_amount)
    ...
    investment_recomendation = get_recomendation(risk_level)
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            you can now see your personalized portfolio recomendation. {}
            """.format(
